...
var SampleSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("\u521D\u59CB\u5316\u6A21\u7248").setDesc("\u53EF\u901A\u8FC7\u547D\u4EE4\u63D2\u5165\u7684\u6587\u672C").addTextArea((text) => text.setPlaceholder("\u8BF7\u8F93\u5165").setValue(this.plugin.settings.pattern).onChange(async (value) => {
...
function formatDateTime(time, format = "YYYY-MM-DD HH:mm:ss") {
  return (0, import_dayjs.default)(time).format(format);
}
